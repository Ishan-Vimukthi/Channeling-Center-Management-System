...
if (strlen($_SESSION['id']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $stmt = $con->prepare("CALL AddPatient(?, ?, ?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("issssiss", $docid, $patname, $patcontact, $patemail, $gender, $pataddress, $patage, $medhis);
        ...
        if ($stmt->execute()) {
            ...
            echo "<script>alert('Error adding patient info');</script>";
        }
